...
Stage01Scene::Stage01Scene(const Scene& _nowScene)
{
	...
	for (int i = 0; i < 3; i++)
	{
		if (i <= 1)
		{
  			mCheckPointBoard = new CheckpointBoard(Vector3(800.0f, 300.0f, (-79500.0f + i * 24000.0f)), Vector3::Zero, Tag::checkpoint, Scene::stage01);

		}
		else
		{
			mCheckPointBoard = new CheckpointBoard(Vector3(800.0f, 300.0f, -36800), Vector3::Zero, Tag::checkpoint, Scene::stage01);
		}
	}
