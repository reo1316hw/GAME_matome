...
*/
TutorialEffect::TutorialEffect(const Vector3& _pos, const Vector3& _vel, const Tag& _objectTag, const SceneBase::Scene _sceneTag)
...
*/
void TutorialEffect::UpdateGameObject(float _deltaTime)
{
