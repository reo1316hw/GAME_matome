...
*/
GameClearScene::GameClearScene(const Scene& _NowScene)
{
	//環境光
	...
	mSprite = new Sprite("Assets/BackGround/GameClear.png");
...
*/
SceneBase* GameClearScene::UpdateScene(const InputState& _KeyState)
{
	//次のシーンに遷移するタイミング
