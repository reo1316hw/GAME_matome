...
*/
GameOverScene::GameOverScene(const Scene& _NowScene)
{
	//環境光
	...
	mSprite = new Sprite("Assets/BackGround/GameOver.png");
...
*/
SceneBase* GameOverScene::UpdateScene(const InputState& _KeyState)
{
	//次のシーンに遷移するタイミング
