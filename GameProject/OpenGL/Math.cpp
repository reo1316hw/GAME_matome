...
float Quintic::EaseIn(float _elapseTime, float _initpos, float _differencePos, float _totalTime)
{
    ...
    return sum = _differencePos * _elapseTime *_elapseTime + _initpos;
}

//イーズアウト
float Quintic::EaseOut(float _elapseTime, float _initpos, float _differencePos,float _totalTime)
{
    float sum = 0;
    _elapseTime /= _totalTime;
    return sum = -_differencePos *_elapseTime * (_elapseTime - 2.0f) + _initpos;
}

//イーズイン
float Quartic::EaseIn(float _elapseTime, float _initpos, float _differencePos, float _totalTime)
{
    float sum = 0;
    _elapseTime /= _totalTime;
    return sum = _differencePos * _elapseTime * _elapseTime * _elapseTime * _elapseTime + _initpos;
}

//イーズアウト
float Quartic::EaseOut(float _elapseTime, float _initpos, float _differencePos, float _totalTime)
{
    float sum = 0;
    _elapseTime /= _totalTime;

    _elapseTime = _elapseTime - 1.0f;
    return sum = -_differencePos* (_elapseTime * _elapseTime * _elapseTime * _elapseTime - 1.0f) + _initpos;
}
//////////////////////////////////////
