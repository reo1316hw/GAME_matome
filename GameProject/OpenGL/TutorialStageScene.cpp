...
*/
TutorialStageScene::TutorialStageScene(const Scene& _NowScene)
	: mTransitionFlag(false)
{
	...
	mSprite = new Sprite("Assets/BackGround/TutorialStage.png");
	...
	//ゴールワープ板生成
	mGoalWarpBorard = new GoalWarpBorard(Vector3(800.0f, 350.0f, -74600.0f), Vector3::sZERO,"Assets/Texture/Board/Warp.png" ,Tag::eOtherTag, _NowScene);
...
*/
SceneBase* TutorialStageScene::UpdateScene(const InputState& _KeyState)
{
	//次のシーンに遷移するタイミング
